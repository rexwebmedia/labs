<x-admin-layout>
    <div class="xl:container px-3 py-4">
        <div class="flex mb-3 justify-between">
            <div class="">
                <h1 class="text-2xl font-semibold">Lab Items</h1>
            </div>
            <div class="self-center">
                <form action="{{ route('lab-items.store') }}" method="post" data-js="form-model-create">
                    ...
                    @if(!empty($items) && count($items))
                        @foreach($items as $item)
                            <tr class="border-b">
                                ...
                                <td class="px-3 py-2">
                                    <a href="{{ route('lab-items.edit', $item) }}">Edit</a>
                                </td>
                            </tr>
                        @endforeach
                    @else
