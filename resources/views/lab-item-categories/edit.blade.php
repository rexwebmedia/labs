<x-admin-layout>
    <div class="xl:container px-4 py-4">
        <div class="flex mb-3 justify-between">
            <div class="">
                <h1 class="text-2xl font-semibold">Lab Item Category</h1>
            </div>
            <div class="self-center">
            </div>
        </div>
        <div class="">
            <form action="{{ route('lab-item-categories.update', $item) }}" method="post" data-js="app-form">
                <div class="flex flex-wrap -mx-2">
                    ...
                    <div class="w-full px-2 flex gap-2 flex-wrap">
                        <x-button href="{{ route('lab-item-categories.index') }}">
                            Back
                        </x-button>
