                ...
                <div id="app-sidebar-container" class="flex flex-col">
                    ...
                    <div id="app-sidebar" class="flex flex-col bg-white shadow-sm">
                        ...
                        <div class="grow overflow-y-auto app-scrollbar border-b">
                            <a href="{{ route('dashboard') }}" class="{{ request()->routeIs('dashboard') ? 'text-primary bg-primary-50' : 'text-gray-600 hover:bg-gray-100' }} flex px-2 py-2 border-b items-center gap-2 font-medium">
                            ...
                            <a href="{{ route('doctors.index') }}" class="{{ request()->routeIs('doctors.index') ? 'text-primary bg-primary-50' : 'text-gray-600 hover:bg-gray-100' }} flex px-2 py-2 border-b items-center gap-2 font-medium">
